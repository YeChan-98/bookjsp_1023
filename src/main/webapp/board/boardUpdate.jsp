...
<br><br>
      ...
      <form name="frm" method="post" action="BoardServlet">
        ...
        <br>
        <br> 
        <div class="buttonst"><input type="submit" value="등록" onclick="return boardCheck()"> </div>
        <div class="buttonst"><input type="reset" value="다시 작성"> </div>
        <div class="buttonst"><input type="button" value="목록" onclick="location.href='BoardServlet?command=board_list'"></div>
      </form>
    </div>
